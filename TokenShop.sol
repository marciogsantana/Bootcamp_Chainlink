...
interface TokenInterface {
    function mint(address account, uint256 amount) external; // passa a interface da função que eu quero do contrato Token
}
...
contract TokenShop {
    ...
    constructor(address tokenAddress) {
        minter = TokenInterface(tokenAddress); // endereço contrato token
        /**
        * Network: Sepolia
        * Aggregator: ETH/USD
        * Address: 0x694AA1769357215DE4FAC081bf1f309aDC325306  // endereço contrato Chainlink
        */
